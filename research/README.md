...
## Вывод
В данной работе была продемонстрирована эффективность мультимедийных операций AVX2 и использование компилятором такой оптимизации, как разворачивание циклов. В данной задаче разворачивание циклов показало себя не очень хорошо, т.к. там где она оно используется присут